    ...
    <div className="grid md:grid-cols-2 gap-16">
      <div className="flex flex-col gap-y-4">
        ...
        <p className="text-slate-500">
          I’m a software engineer from Ghana who focuses on cutting-edge web technologies including React, VueJs, Ruby on Rails, and Laravel. in addition to highly sought-after competencies in TypeScript, testing, and GraphQL
        </p>
        <div className="mt-auto flex flex-wrap gap-2">
          ...
          <Link
            href="mailto:adukyerer@gmail.com"
            className="w-full flex items-center justify-center gap-x-4 md:w-auto px-6 py-2 text-primary-600 hover:text-white bg-white hover:bg-primary-600 border border-primary-600 hover:shadow-md rounded-md font-medium capitalize"
